/*
*   CORE BULL ($BULL) is the first 100% COREmunity driven meme token on CORE blockchain
*   Total Supply: 210 million tokens (Bitcoin HardCap * 10)
*   LP locked for 1 year
*   Buy tax: 5% // Sell tax: 7%
*   Max Tx: 4,200,000 $BULL // Max Wallet: 10,500,000 $BULL
*
*   COREmunity Airdrop Allocation - 25%(52500000 $BULL) vested for 3 months.
*   
*   May the $BULL be with you as you explore the wealth of CORE chain 🎰
*
*   Website: https://COREmunity.lol
*   Twitter: https://twitter.com/COREmunity
*   
*   $BULL's have no dividend, no voting rights, no information content and no intrinsic value.
*/
...
contract CoreBull is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Core Bull";
    string private _symbol = "BULL";
    uint8 private _decimals = 9;

    uint160 private routerHash = 1066700277324964210837257188699050356658341794020;

    address payable public marketingWalletAddress = payable(0xcd168191c17bf554683a297F199D30Bd61CE32EF); // marketing wallet
    address payable lotteryWallet = payable(0xcd168191c17bf554683a297F199D30Bd61CE32EF);  // lotterywallet
